...
library(coloc)
library(tidyverse)
setwd("~/MiniProject2/genexpression/Coloc")
...
df<-fread("/projects/MRC_IEU/research/projects/icep2/wp2/034/working/results/MiniProject2/MR_Results_Filtered.csv")
#FDR
df$bh_p =
  p.adjust(df$"pval",
           method = "BH")
...
#Can't work out what this chunk of code was for, maybe to get positions?
file <- fread("Allgeneswithgencode_AN.csv")
...
outcome_dat <- read_outcome_data(
  ...
  filename = "/projects/MRC_IEU/research/projects/icep2/wp2/005/working/data/gecco/annotated/overall_CRC_GWAS_noUKBio_summary_stats_annotated.txt",
  sep = " ",
  snp_col = "SNP",
  beta_col = "Effect",
  se_col = "StdErr",
...
#overall
CRC<-fread("/projects/MRC_IEU/research/projects/icep2/wp2/005/working/data/gecco/annotated/overall_CRC_GWAS_noUKBio_summary_stats_annotated.txt")
overall_eQTL<-eQTL[which(eQTL$id.outcome=="overall"),]
